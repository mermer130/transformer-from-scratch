...
从一句文本怎样变成张量开始，依次写出位置编码、注意力、编码器、解码器、训练和束搜索。每一步只交付一个函数，最后得到一套能跑通前向与训练的 Transformer。
...
- [ ] **68.** apply_adam_step_to_all_parameters
- [ ] **69.** zero_all_parameter_gradients
- [ ] **70.** compute_batch_training_loss
- [ ] **71.** run_training_step_with_backprop
- [ ] **72.** run_training_loop_for_steps
- [ ] **73.** pick_next_token_by_argmax
- [ ] **74.** compute_length_penalty
- [ ] **75.** compute_candidate_scores
- [ ] **76.** select_top_k_candidates
- [ ] **77.** append_tokens_to_beam_sequences
- [ ] **78.** mark_finished_beams
- [ ] **79.** select_best_finished_beam
